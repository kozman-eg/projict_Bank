 ...
 float clsCurrencyCalculatorScreen::_ReadAmount()
    {
     ...
     clsCurrency clsCurrencyCalculatorScreen::_GetCurrency(string Message)
    {
      ...
      void clsCurrencyCalculatorScreen::_PrintCurrencyCard(clsCurrency Currency, string Title )
    {
     ...
     void clsCurrencyCalculatorScreen::_PrintCalculationsResults(float Amount, clsCurrency Currency1, clsCurrency Currency2)
    {
